...
5. Save best params + model weights + predictions under results/clinical/.
...
# Config
# ─────────────────────────────────────────────
FOLDER_ROOT = SCRIPTS_DIR.parent
CLINICAL_CSV = FOLDER_ROOT / "data" / "clinical_encoded.csv"
OUT_DIR = FOLDER_ROOT / "results" / "clinical"
