...
- CT numbers come from experiments/m1_hosny_iter7b_seed99/optuna_mlp/optuna_mlp_summary.json.
...
SM_DIR = REPO_ROOT / "experiments" / "single_modal"
CT_SUM = REPO_ROOT / "experiments" / "m1_hosny_iter7b_seed99" / "optuna_mlp" / "optuna_mlp_summary.json"
