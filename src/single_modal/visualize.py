...
Output directory is resolved relative to this file (experiments/single_modal/figures/).
"""
...
CT_MLP_DIR = REPO_ROOT / "experiments" / "m1_hosny_iter7b_seed99" / "optuna_mlp"
FIG_DIR = SM_DIR / "figures"
